...
class ParserTest(unittest.TestCase):
	...
	def test_get_from_adress_from_line(self):
		self.assertEqual(parser.get_from_adress_from_line('Jul 10 10:35:54 srv24-s-st postfix/qmgr[3043]: DEEA5DF03F0: from=<info@auraltc.ru>, status=expired, returned to sender'), 'info@auraltc.ru')

	def test_get_id_from_line(self):
		self.assertEqual(parser.get_id_from_line('Jul 10 10:35:54 srv24-s-st postfix/qmgr[3043]: DEEA5DF03F0: from=<info@auraltc.ru>, status=expired, returned to sender'), 'DEEA5DF03F0')
	...
	def test_pretty_print(self):
		...
		self.assertEqual(parser.pretty_print_counter(dictO),
